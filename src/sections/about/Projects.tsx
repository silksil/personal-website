...
const projects = [
  {
    ...
    description: 'Created a NFT collection that aimed to raise funds for Ukraine by making fun of Putin. Responsible for the smart-contract, UI and front-end.',
  ...
  },
  {
    ...
    description: 'Responsible for developing and deploying a mobile app that allows you to detect Scoliosis through 3D technology.',
  ...
  {
    title: 'Stick',
    description: 'To develop my Figma skills, I designed an app that makes it easy to capture your key learnings from books and podcasts.',
